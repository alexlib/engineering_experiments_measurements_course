...
get_ipython().run_line_magic('timeit', 'fft(g)')
get_ipython().run_line_magic('timeit', 'fft(g[:256])   # 256 points instead of 301, not waisting much data')


# even if it's longer, but the right size with zeros at the end
g1 = zeros((512,))
g1[:301] = g.copy()
get_ipython().run_line_magic('timeit', 'fft(g1)')
